    ...
    <div className="min-h-screen bg-[hsl(224,71%,4%)] text-white overflow-x-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className={cn(
                ...
                'xp-gradient text-white shadow-lg shadow-purple-900/30 border-0 hover:opacity-90'
              )}
            >
              Get Started Free
            </Link>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-purple-600/20 blur-[120px]" />
          <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] rounded-full bg-blue-600/15 blur-[100px]" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-sm text-white/80 mb-8">
          ...
          >
            <Link
              ...
              className={cn(
                ...
                'xp-gradient text-white shadow-xl shadow-purple-900/40 border-0 hover:opacity-90 px-8'
              )}
            >
      ...
      <section className="py-24 px-6 bg-[hsl(224,71%,2%)]">
        <div className="max-w-6xl mx-auto">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 20 }}
            ...
            {(() => {
              ...
              return (
                <motion.div
                  key={ceo.level}
                  className={cn(
                    'glass-card rounded-2xl p-6 border border-white/10 rarity-legendary',
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="xp-gradient rounded-3xl p-12 text-center relative overflow-hidden">
            {/* Dark overlay */}
            <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-black/30 rounded-3xl" />
            {/* Decorative orbs */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  ...
                  className={cn(
                    buttonVariants({ size: 'lg' }),
                    'bg-white text-purple-700 hover:bg-white/90 font-semibold px-8 border-0'
                  )}
                >
                ...
                <Link
                  ...
                  className={cn(
                    buttonVariants({ variant: 'outline', size: 'lg' }),
                    'border-white/40 text-white hover:bg-white/10 hover:text-white px-8'
                  )}
                >
                  Sign In
                </Link>
      ...
      <footer className="border-t border-white/10 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-sm">© 2025 CEOhabits. Build your legacy.</p>
          <Link
            to="/auth"
            className={cn(
              buttonVariants({ variant: 'ghost', size: 'sm' }),
